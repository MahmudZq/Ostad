...
/*-- Procedure with user file --*/
    $filename = "C:/xampp/htdocs/Ostad-PHP-main/Module_5/user.txt";
    $fp = fopen($filename, "a+");
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ms-auto text-uppercase">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="admin_home.php"
                                    <?php if($current == "admin_home"){ ?> id="active" <?php } ?>>Home</a>
                            </li>
                            <?php } else{ ?>
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="user_home.php"
                                    <?php if($current == "user_home"){ ?> id="active" <?php } ?>>Home</a>
                            </li>
                            <?php } ?>
                            <?php if($_SESSION['userRole'] == "Admin"){ ?>
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="users.php"
                                    <?php if($current == "users"){ ?> id="active" <?php } ?>>Users</a>
                            </li>
                            <?php } ?>
                            <li class="nav-item dropdown ms-5">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item logout" href="admin_home.php?action=logout">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
