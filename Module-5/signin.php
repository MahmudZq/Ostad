...
/*-- Procedure with file --*/
$filename = "C:/xampp/htdocs/Ostad-PHP-main/Module-5/user.txt";
$fp = fopen($filename, "a+");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                            <div class="row justify-content-center fs-5">
                                ...
                                <div class="col-12 mt-5">
                                    <button class="btn btn-primary shadow-none text-white w-100 fs-5" type="submit"
                                        name="signin">Sign In</button>
                                </div>

                                <div class="col-6 mt-5">
                                    <p class="text-center">Forgot Password? <a href="#"
                                            class="text-decoration-none fw-bold">Find</a></p>
                                </div>

                                <div class="col-6 mt-5">
                                    <p class="text-center">Don't have an account? <a href="signup.php"
                                            class="text-decoration-none fw-bold">Create</a></p>
                                </div>
                            </div>
                        </form>
                        <!-- Form End -->
