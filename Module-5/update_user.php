                    ...
                    <form action="" method="POST">
                        <div class="row justify-content-center fs-5">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <input type="text" <?php if ($updateId != $_SESSION['userId']) { ?> readonly <?php } ?>
                                    name="firstName" value="<?php echo $singleUserData[1]; ?>"
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <input type="text" <?php if ($updateId != $_SESSION['userId']) { ?> readonly <?php } ?>
                                    name="lastName" value="<?php echo $singleUserData[2]; ?>" class="form-control fs-5">
                            </div>

                            <div class="col-12 mb-2">
                                <label for="userName">Username</label>
                                <input type="text" <?php if ($updateId != $_SESSION['userId']) { ?> readonly <?php } ?>
                                    name="userName" value="<?php echo $singleUserData[3]; ?>" class="form-control fs-5">
                            </div>

                            <div class="col-12 mb-2">
                                <label for="mailAddress">Email</label>
                                <input type="text" <?php if ($updateId != $_SESSION['userId']) { ?> readonly <?php } ?>
                                    name="mailAddress" value="<?php echo $singleUserData[4]; ?>"
                                    class="form-control fs-5">
                            </div>
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <select name="role" class="form-select fs-5">
                                    <option value="Admin" <?php if ($singleUserData[0] == "Admin") {
                                                                                echo "selected";
                                                                            } ?>>Admin</option>
                                    <option value="User" <?php if ($singleUserData[0] == "User") {
                                                                                echo "selected";
                                                                            } ?>>
                                        User</option>
                                </select>
                            ...
                            <div class="col-12 mt-5">
                                <input class="btn btn-primary shadow-none text-white w-100 fs-5" type="submit"
